...
export default function Social() {
  return (
    <div className="social">
      <a className='social__single twitter' href='https://twitter.com/twoartwork' target='_blank'>
        <SvgTwitter />
      </a>
      <a className='social__single instagram' href='https://instagram.com/twoartwork' target='_blank'>
        <SvgInstagram />
      </a>
